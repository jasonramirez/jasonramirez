  class EnablePgvectorAndAddEmbeddings < ActiveRecord::Migration[8.0]
    def change
      ...
      add_column :knowledge_items, :content_embedding, "vector(1536)"
      add_column :knowledge_items, :title_embedding, "vector(1536)"
      
      # Add embedding columns for conversation memory
      add_column :chat_messages, :content_embedding, "vector(1536)"
